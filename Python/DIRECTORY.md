...
## Arithmetic Analysis
  * [Bisection](backtracking/audio_filters/arithmetic_analysis/bisection.py)
  * [Gaussian Elimination](backtracking/audio_filters/arithmetic_analysis/gaussian_elimination.py)
  * [In Static Equilibrium](backtracking/audio_filters/arithmetic_analysis/in_static_equilibrium.py)
  * [Intersection](backtracking/audio_filters/arithmetic_analysis/intersection.py)
  * [Jacobi Iteration Method](backtracking/audio_filters/arithmetic_analysis/jacobi_iteration_method.py)
  * [Lu Decomposition](backtracking/audio_filters/arithmetic_analysis/lu_decomposition.py)
  * [Newton Forward Interpolation](backtracking/audio_filters/arithmetic_analysis/newton_forward_interpolation.py)
  * [Newton Method](backtracking/audio_filters/arithmetic_analysis/newton_method.py)
  * [Newton Raphson](backtracking/audio_filters/arithmetic_analysis/newton_raphson.py)
  * [Secant Method](backtracking/audio_filters/arithmetic_analysis/secant_method.py)

## Audio Filters
  * [Butterworth Filter](backtracking/audio_filters/butterworth_filter.py)
  * [Iir Filter](backtracking/audio_filters/iir_filter.py)
  * [Show Response](backtracking/audio_filters/show_response.py)
...
## Bit Manipulation
  * [Binary And Operator](blockchain/bit_manipulation/binary_and_operator.py)
  * [Binary Count Setbits](blockchain/bit_manipulation/binary_count_setbits.py)
  * [Binary Count Trailing Zeros](blockchain/bit_manipulation/binary_count_trailing_zeros.py)
  * [Binary Or Operator](blockchain/bit_manipulation/binary_or_operator.py)
  * [Binary Shifts](blockchain/bit_manipulation/binary_shifts.py)
  * [Binary Twos Complement](blockchain/bit_manipulation/binary_twos_complement.py)
  * [Binary Xor Operator](blockchain/bit_manipulation/binary_xor_operator.py)
  * [Count 1S Brian Kernighan Method](blockchain/bit_manipulation/count_1s_brian_kernighan_method.py)
  * [Count Number Of One Bits](blockchain/bit_manipulation/count_number_of_one_bits.py)
  * [Gray Code Sequence](blockchain/bit_manipulation/gray_code_sequence.py)
  * [Reverse Bits](blockchain/bit_manipulation/reverse_bits.py)
  * [Single Bit Manipulation Operations](blockchain/bit_manipulation/single_bit_manipulation_operations.py)
...
## Boolean Algebra
  * [Quine Mc Cluskey](backtracking/audio_filters/boolean_algebra/quine_mc_cluskey.py)
...
## Data Structures
  * Binary Tree
    * [Avl Tree](backtracking/audio_filters/data_structures/binary_tree/avl_tree.py)
    * [Basic Binary Tree](backtracking/audio_filters/data_structures/binary_tree/basic_binary_tree.py)
    * [Binary Search Tree](backtracking/audio_filters/data_structures/binary_tree/binary_search_tree.py)
    * [Binary Search Tree Recursive](backtracking/audio_filters/data_structures/binary_tree/binary_search_tree_recursive.py)
    * [Binary Tree Mirror](backtracking/audio_filters/data_structures/binary_tree/binary_tree_mirror.py)
    * [Binary Tree Traversals](backtracking/audio_filters/data_structures/binary_tree/binary_tree_traversals.py)
    * [Fenwick Tree](backtracking/audio_filters/data_structures/binary_tree/fenwick_tree.py)
    * [Lazy Segment Tree](backtracking/audio_filters/data_structures/binary_tree/lazy_segment_tree.py)
    * [Lowest Common Ancestor](backtracking/audio_filters/data_structures/binary_tree/lowest_common_ancestor.py)
    * [Merge Two Binary Trees](backtracking/audio_filters/data_structures/binary_tree/merge_two_binary_trees.py)
    * [Non Recursive Segment Tree](backtracking/audio_filters/data_structures/binary_tree/non_recursive_segment_tree.py)
    * [Number Of Possible Binary Trees](backtracking/audio_filters/data_structures/binary_tree/number_of_possible_binary_trees.py)
    * [Red Black Tree](backtracking/audio_filters/data_structures/binary_tree/red_black_tree.py)
    * [Segment Tree](backtracking/audio_filters/data_structures/binary_tree/segment_tree.py)
    * [Segment Tree Other](backtracking/audio_filters/data_structures/binary_tree/segment_tree_other.py)
    * [Treap](backtracking/audio_filters/data_structures/binary_tree/treap.py)
    * [Wavelet Tree](backtracking/audio_filters/data_structures/binary_tree/wavelet_tree.py)
  * Disjoint Set
    * [Alternate Disjoint Set](backtracking/audio_filters/data_structures/disjoint_set/alternate_disjoint_set.py)
    * [Disjoint Set](backtracking/audio_filters/data_structures/disjoint_set/disjoint_set.py)
  * Hashing
    * [Double Hash](backtracking/audio_filters/data_structures/hashing/double_hash.py)
    * [Hash Table](backtracking/audio_filters/data_structures/hashing/hash_table.py)
    * [Hash Table With Linked List](backtracking/audio_filters/data_structures/hashing/hash_table_with_linked_list.py)
    * Number Theory
      * [Prime Numbers](backtracking/audio_filters/data_structures/hashing/number_theory/prime_numbers.py)
    * [Quadratic Probing](backtracking/audio_filters/data_structures/hashing/quadratic_probing.py)
  * Heap
    * [Binomial Heap](backtracking/audio_filters/data_structures/heap/binomial_heap.py)
    * [Heap](backtracking/audio_filters/data_structures/heap/heap.py)
    * [Heap Generic](backtracking/audio_filters/data_structures/heap/heap_generic.py)
    * [Max Heap](backtracking/audio_filters/data_structures/heap/max_heap.py)
    * [Min Heap](backtracking/audio_filters/data_structures/heap/min_heap.py)
    * [Randomized Heap](backtracking/audio_filters/data_structures/heap/randomized_heap.py)
    * [Skew Heap](backtracking/audio_filters/data_structures/heap/skew_heap.py)
  * Linked List
    * [Circular Linked List](backtracking/audio_filters/data_structures/linked_list/circular_linked_list.py)
    * [Deque Doubly](backtracking/audio_filters/data_structures/linked_list/deque_doubly.py)
    * [Doubly Linked List](backtracking/audio_filters/data_structures/linked_list/doubly_linked_list.py)
    * [Doubly Linked List Two](backtracking/audio_filters/data_structures/linked_list/doubly_linked_list_two.py)
    * [From Sequence](backtracking/audio_filters/data_structures/linked_list/from_sequence.py)
    * [Has Loop](backtracking/audio_filters/data_structures/linked_list/has_loop.py)
    * [Is Palindrome](backtracking/audio_filters/data_structures/linked_list/is_palindrome.py)
    * [Merge Two Lists](backtracking/audio_filters/data_structures/linked_list/merge_two_lists.py)
    * [Middle Element Of Linked List](backtracking/audio_filters/data_structures/linked_list/middle_element_of_linked_list.py)
    * [Print Reverse](backtracking/audio_filters/data_structures/linked_list/print_reverse.py)
    * [Singly Linked List](backtracking/audio_filters/data_structures/linked_list/singly_linked_list.py)
    * [Skip List](backtracking/audio_filters/data_structures/linked_list/skip_list.py)
    * [Swap Nodes](backtracking/audio_filters/data_structures/linked_list/swap_nodes.py)
  * Queue
    * [Circular Queue](backtracking/audio_filters/data_structures/queue/circular_queue.py)
    * [Circular Queue Linked List](backtracking/audio_filters/data_structures/queue/circular_queue_linked_list.py)
    * [Double Ended Queue](backtracking/audio_filters/data_structures/queue/double_ended_queue.py)
    * [Linked Queue](backtracking/audio_filters/data_structures/queue/linked_queue.py)
    * [Priority Queue Using List](backtracking/audio_filters/data_structures/queue/priority_queue_using_list.py)
    * [Queue On List](backtracking/audio_filters/data_structures/queue/queue_on_list.py)
    * [Queue On Pseudo Stack](backtracking/audio_filters/data_structures/queue/queue_on_pseudo_stack.py)
  * Stacks
    * [Balanced Parentheses](backtracking/audio_filters/data_structures/stacks/balanced_parentheses.py)
    * [Dijkstras Two Stack Algorithm](backtracking/audio_filters/data_structures/stacks/dijkstras_two_stack_algorithm.py)
    * [Evaluate Postfix Notations](backtracking/audio_filters/data_structures/stacks/evaluate_postfix_notations.py)
    * [Infix To Postfix Conversion](backtracking/audio_filters/data_structures/stacks/infix_to_postfix_conversion.py)
    * [Infix To Prefix Conversion](backtracking/audio_filters/data_structures/stacks/infix_to_prefix_conversion.py)
    * [Next Greater Element](backtracking/audio_filters/data_structures/stacks/next_greater_element.py)
    * [Postfix Evaluation](backtracking/audio_filters/data_structures/stacks/postfix_evaluation.py)
    * [Prefix Evaluation](backtracking/audio_filters/data_structures/stacks/prefix_evaluation.py)
    * [Stack](backtracking/audio_filters/data_structures/stacks/stack.py)
    * [Stack With Doubly Linked List](backtracking/audio_filters/data_structures/stacks/stack_with_doubly_linked_list.py)
    * [Stack With Singly Linked List](backtracking/audio_filters/data_structures/stacks/stack_with_singly_linked_list.py)
    * [Stock Span Problem](backtracking/audio_filters/data_structures/stacks/stock_span_problem.py)
  * Trie
    * [Trie](backtracking/audio_filters/data_structures/trie/trie.py)
...
## Scheduling
  * [First Come First Served](scripts/scheduling/first_come_first_served.py)
  * [Highest Response Ratio Next](scripts/scheduling/highest_response_ratio_next.py)
  * [Multi Level Feedback Queue](scripts/scheduling/multi_level_feedback_queue.py)
  * [Non Preemptive Shortest Job First](scripts/scheduling/non_preemptive_shortest_job_first.py)
  * [Round Robin](scripts/scheduling/round_robin.py)
  * [Shortest Job First](scripts/scheduling/shortest_job_first.py)
